const Login = () => {
    return (
      <div className="grid grid-cols-1 lg:grid-cols-2 relative">
        <div className="bg-tea-green h-[250px] lg:h-screen">
          <h1 className="flex justify-center text-light-brown m-8">Andres Power Nutrition </h1>
        </div>
        <form>
          <div className="flex flex-col items-center justify-center absolute h-screen w-full lg:relative top-0 ">
            <div className="rounded-lg overflow-hidden bg-white lg:w-full w-[90%] h-[60%] flex flex-col items-center border sm:border-1 md:border-none lg:border-none">
              ...
              <div className="flex flex-col w-full lg:w-[70%] px-4 gap-2">
                ...
                <input type="email" 
                      className="border border-1 rounded-full w-full text-center h-9 hover:border-fluorescent-green focus:outline-none"></input>
              </div>
              <div className="flex flex-col w-full lg:w-[70%] px-4 gap-2">
                <h4 className="text-sm font-bold">contraseña</h4>
                <input type="password"
                      className="border border-1 rounded-full text-center h-9 hover:border-fluorescent-green focus:outline-none"/>
              </div>
              <a
                href=""
              ...
              <button className="bg-dark-green rounded-full w-28 h-10 mt-4 hover:bg-tea-green">
                Log In
              </button>   
            </div>
          </div>
